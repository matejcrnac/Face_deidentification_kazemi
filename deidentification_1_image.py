...
if __name__ == "__main__":
    ...
    sorted_closest_indexes = find_closest_Image_sorted_list(image_positions, templates_positions,method = "landmarks_distances_all",  k=4) #find k-th closest image index
    ...
    showImage_more(img=image/255., text=str(k), gray=False)
    cv2.waitKey(0)
