...
if __name__ == "__main__":
    ...
    destination = destination_folder + "/deidentification_destination_all_images_all_k_no_comparing_landmar_distances_spec_extracted_" + "/"
